...
export default class ImageList extends Component{
    ...
    renderImageList(){
        ...
        if(children){
            return <div className={classnames(this.getProperty(true), className, setPhPrefix("column-"+column))}>{children}</div>
        }else{
            return (
                <div className={classnames(this.getProperty(true), className, setPhPrefix("column-"+column))}>
                    {
                        images.map((data,index)=>{
                            return (
                                <dl key={index} onClick={::this.clickCallback.bind(this,data)}>
                                    ...
                                    <dd>
                                        <p className={setPhPrefix('image-title')}>{this.formatParams(titleField, data.title)}</p>
                                        <p className={setPhPrefix('image-desp')}>{this.formatParams(despField, data.desp)}</p>
