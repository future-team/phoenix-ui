            ...
            <Grid className="detail-demo">
                ...
                <FormGroup>
                    <Row>
                        <Col width="60">
                            <label>门店浏览量</label>
                            <div className="ph-input">395826</div>
                        </Col>
                        <Col className="ph-input">
                    ...
                    <Row>
                        <Col>
                            <a href="###" className="ph-navigate-right">
                                <label>性别</label>
                ...
                <FormGroup style={{marginBottom: "60px"}}>
                    ...
                    <Row style={{height:"80px"}}>
                        <Col>
                            <Row>
                                <Col width="10" style={{margin: "8px 0 0 15px"}}>
                                    <Label>惠</Label>
                                </Col>
                                <Col className="ph-input">上海欢乐谷门票</Col>
                            </Row>
                            <Row>
                                <Col>
                                    <label>$190</label>
