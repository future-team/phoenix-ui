...
import LoadingList from "phoenix-ui/lib/LoadingList";
    ...
    render(){
        return(
            <div>
                ...
                <h3 className="comp-type">loadCallback函数 点击按钮加载或滑到底部自动加载的回调函数</h3>
                <h3 className="comp-type">loadEndCallback函数 每次加载结束的回调函数</h3>
                <LoadingList phMode="auto" loadingStatus={this.state.loadingStatus} 
                    ...
                    loadCallback={this.loadCallback.bind(this)} loadEndCallback={this.loadEndCallback.bind(this)}>
                    <ul>
                        {
